...
import { Package, MapPin, CheckCircle, User, ArrowLeft, Building2 } from "lucide-react";
    ...
    <div className="relative min-h-screen font-kanit">
      ...
      <div className="relative z-10 px-4 pt-20 pb-32 max-w-[720px] mx-auto">
        <div className="backdrop-blur-sm bg-white/85 rounded-2xl shadow-xl p-5">
          <button onClick={handleBack} className="flex items-center gap-2 text-orange-500 font-semibold mb-4">
            <ArrowLeft size={20} />
            ย้อนกลับ
          </button>
            ...
            <section className="bg-white/95 p-4 rounded-xl shadow border border-orange-200">
              <div className="mb-3 flex items-center justify-between gap-2">
                ...
                {totalEquipmentQuantity > 0 && (
                  <span className="text-sm font-semibold text-orange-600">ทั้งหมด {totalEquipmentQuantity} ชิ้น</span>
                )}
              </div>
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-gray-600">
                          จำนวนที่จอง <span className="font-semibold text-orange-500">x{item.quantity}</span>
                        </p>
                      </div>
                    </div>
                  ))}
